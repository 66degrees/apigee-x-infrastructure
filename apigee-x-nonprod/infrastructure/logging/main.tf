...
module "log_export_to_storage" {
  ...
  log_sink_name          = "logging-bucket-sink"
  parent_resource_id     = var.project_id
  parent_resource_type   = "project"
  include_children       = false # Set to false since this is project-level logging
...
module "storage_destination" {
  ...
  storage_bucket_name         = "logs-bucket-${var.project_id}-${random_string.suffix.result}"
